...
var (
	xunfei                  = syscall.NewLazyDLL("xunfei.dll")
	procMSPDownloadData     = xunfei.NewProc("xfMSPDownloadData")
	procMSPGetParam         = xunfei.NewProc("xfMSPGetParam")
	procMSPGetVersion       = xunfei.NewProc("xfMSPGetVersion")
	procMSPLogin            = xunfei.NewProc("xfMSPLogin")
	procMSPLogout           = xunfei.NewProc("xfMSPLogout")
	procMSPNlpSchCancel     = xunfei.NewProc("xfMSPNlpSchCancel")
	procMSPNlpSearch        = xunfei.NewProc("xfMSPNlpSearch")
	procMSPRegisterNotify   = xunfei.NewProc("xfMSPRegisterNotify")
	procMSPSearch           = xunfei.NewProc("xfMSPSearch")
	procMSPSetParam         = xunfei.NewProc("xfMSPSetParam")
	procMSPUploadData       = xunfei.NewProc("xfMSPUploadData")
	procQISEAudioWrite      = xunfei.NewProc("xfQISEAudioWrite")
	procQISEGetParam        = xunfei.NewProc("xfQISEGetParam")
	procQISEGetResult       = xunfei.NewProc("xfQISEGetResult")
	procQISEResultInfo      = xunfei.NewProc("xfQISEResultInfo")
	procQISESessionBegin    = xunfei.NewProc("xfQISESessionBegin")
	procQISESessionEnd      = xunfei.NewProc("xfQISESessionEnd")
	procQISETextPut         = xunfei.NewProc("xfQISETextPut")
	procQISRAudioWrite      = xunfei.NewProc("xfQISRAudioWrite")
	procQISRBuildGrammar    = xunfei.NewProc("xfQISRBuildGrammar")
	procQISRGetBinaryResult = xunfei.NewProc("xfQISRGetBinaryResult")
	procQISRGetParam        = xunfei.NewProc("xfQISRGetParam")
	procQISRGetResult       = xunfei.NewProc("xfQISRGetResult")
	procQISRSessionBegin    = xunfei.NewProc("xfQISRSessionBegin")
	procQISRSessionEnd      = xunfei.NewProc("xfQISRSessionEnd")
	procQISRSetParam        = xunfei.NewProc("xfQISRSetParam")
	procQISRUpdateLexicon   = xunfei.NewProc("xfQISRUpdateLexicon")
	procQIVWAudioWrite      = xunfei.NewProc("xfQIVWAudioWrite")
	procQIVWRegisterNotify  = xunfei.NewProc("xfQIVWRegisterNotify")
	procQIVWResMerge        = xunfei.NewProc("xfQIVWResMerge")
	procQIVWSessionBegin    = xunfei.NewProc("xfQIVWSessionBegin")
	procQIVWSessionEnd      = xunfei.NewProc("xfQIVWSessionEnd")
	procQTTSAudioGet        = xunfei.NewProc("xfQTTSAudioGet")
	procQTTSAudioInfo       = xunfei.NewProc("xfQTTSAudioInfo")
	procQTTSGetParam        = xunfei.NewProc("xfQTTSGetParam")
	procQTTSSessionBegin    = xunfei.NewProc("xfQTTSSessionBegin")
	procQTTSSessionEnd      = xunfei.NewProc("xfQTTSSessionEnd")
	procQTTSSetParam        = xunfei.NewProc("xfQTTSSetParam")
	procQTTSTextPut         = xunfei.NewProc("xfQTTSTextPut")
)
